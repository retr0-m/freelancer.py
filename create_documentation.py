...
# * USE THIS IN SERVER VERSION
def create_preview_document_server(lead: Lead):
    INPUT_PDF = "./document_templates/proposal.pdf"
    OUTPUT_PDF = f"./server/{TEMP_PATH}/{lead.id}/proposal.pdf"
    QR_IMAGE = f"./server/{TEMP_PATH}/{lead.id}/qr_code.png"
...
if __name__ == "__main__":
    ...
    l=Lead(150, "Al-74", "21312432", "Via Trevano 74, 6900 Lugano, Switzerland", "Lugano", "aa", [], 0)
